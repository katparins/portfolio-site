        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <p className="text-lg md:text-xl text-[#5D4037] leading-relaxed max-w-2xl mb-10 font-light">
              I’m a <span className="font-medium text-[#3E2723]">software engineer</span> who builds digital experiences shaped by <span className="font-medium text-[#5D4037]">creativity, engineering, and data</span>, with a focus on human-centered design and tools that support better work.
            </p>
